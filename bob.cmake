...
function(bob_add_library_or_executable target target_version)
  ...
  if (target MATCHES "^lib|_plugin$")
    if (ARGN)
      ...
      # can be linked as dependency.
      add_library(${target} STATIC ${headers})
      set_property(TARGET ${target} PROPERTY LINKER_LANGUAGE CXX)
      # FIXME: When CMake supports header-only targets, remove code above and use code below
      #        (don't forget to set cmake_minimum_required()).
...
function(bob_add_target target)
  ...
  bob_add_library_or_executable(${target} "${target_version}"
    ${target_compile}
    ${target_sources}
